...
from models import db, User, Planet,Character,Starship,Vehicle,Specie,FavoriteCharacter,FavoritePlanet,FavoriteStarship,FavoriteVehicle,FavoriteSpecie
...
def setup_admin(app):
    ...
    admin.add_view(ModelView(FavoriteSpecie, db.session))
